...
import com.github.shareme.greenandroid.fastadapter.utils.IdDistributor;
...
import com.github.shareme.greenandroid.materialdrawer.util.DrawerImageLoader;
import com.github.shareme.greenandroid.materialdrawer.util.DrawerUIUtils;
import com.github.shareme.greenandroid.materialdrawer.view.BezelImageView;
    ...
    private void handleSelectionView(IProfile profile, boolean on) {
        if (on) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                mAccountHeaderContainer.setForeground(ContextCompat.getDrawable(mAccountHeaderContainer.getContext(), mAccountHeaderTextSectionBackgroundResource));
