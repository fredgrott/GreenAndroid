...
import com.github.shareme.greenandroid.materialdrawer.model.ContainerDrawerItem;
    ...
    public static void handleHeaderView(DrawerBuilder drawer) {
        ...
        if (drawer.mHeaderView != null) {
            ...
            if (drawer.mHeaderPadding) {
                drawer.getHeaderAdapter().add(new ContainerDrawerItem().withView(drawer.mHeaderView).withHeight((DimenHolder) drawer.mHeiderHeight).withDivider(drawer.mHeaderDivider).withViewPosition(ContainerDrawerItem.Position.TOP));
            } else {
                drawer.getHeaderAdapter().add(new ContainerDrawerItem().withView(drawer.mHeaderView).withHeight((DimenHolder) drawer.mHeiderHeight).withDivider(drawer.mHeaderDivider).withViewPosition(ContainerDrawerItem.Position.NONE));
            }
            ...
            if (drawer.mStickyFooterView != null) {
                ...
                DrawerUtils.fillStickyDrawerItemFooter(drawer, drawer.mStickyFooterView, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        com.github.shareme.greenandroid.materialdrawer.DrawerUtils.onFooterDrawerItemClick(drawer, drawerItem, v, true);
                    }
                });
