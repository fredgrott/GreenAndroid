...
public final class Scene {
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(com.github.shareme.greenandroid.transitionseverywhere.R.id.current_scene, scene);
    }
    ...
    public static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(com.github.shareme.greenandroid.transitionseverywhere.R.id.current_scene);
    }
