package com.github.shareme.greenandroid.draglinearlayoutapp;
...
import com.github.shareme.greenandroid.draglinearlayout.DragLinearLayout;
...
public class NoteActivity extends AppCompatActivity {
    ...
    private void addExistingNote(int index, String text){
        ...
        ((ImageView) note.findViewById(R.id.noteIcon)).setImageResource(R.mipmap.ic_drag);
