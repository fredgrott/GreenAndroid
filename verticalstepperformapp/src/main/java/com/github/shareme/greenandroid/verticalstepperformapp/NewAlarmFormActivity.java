package com.github.shareme.greenandroid.verticalstepperformapp;
...
import com.github.shareme.greenandroid.verticalstepperform.VerticalStepperFormLayout;
import com.github.shareme.greenandroid.verticalstepperform.fragments.BackConfirmationFragment;
import com.github.shareme.greenandroid.verticalstepperform.interfaces.VerticalStepperForm;
...
public class NewAlarmFormActivity extends AppCompatActivity implements VerticalStepperForm {
    ...
    private void confirmBack() {
        if(confirmBack && verticalStepperForm.isAnyStepCompleted()) {
            ...
            backConfirmation.show(getFragmentManager(), null);
        } else {
            confirmBack = false;
            finish();
        }
